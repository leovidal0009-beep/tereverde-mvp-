...
const eventos = [
  {
    ...
    descricao: 'O maior festival de cultura e artes do interior fluminense chega a Teresópolis com shows, teatro, dança e muito mais para toda a família.',
    categoria: 'Cultura',
  ...
  },
  {
    ...
    descricao: 'A Feira do Produtor Rural de Teresópolis está de volta! Shows de Samuel Miranda, Yasmin Santos, João Gabriel e Leonardo. Entrada: 1 kg de alimento não perecível.',
    categoria: 'Shows',
  ...
  },
  {
    ...
    descricao: 'O maior arraiá cervejeiro da serra! Cervejas artesanais, gastronomia de rua, shows ao vivo e espaço kids. Entrada franca.',
  ...
  },
  {
    ...
    descricao: 'Uma noite reunindo artistas locais e convidados com influências do jazz e blues afro-americano. Realização da Gama Produções com apoio da Prefeitura. Entrada franca.',
    categoria: 'Música',
...
const categorias = ['Todos', 'Cultura', 'Shows', 'Gastronomia', 'Música'];
    ...
    <div className="eventos-pagina">
      ...
      <div className="guias-filtros">
        {categorias.map(cat => (
          <button
            key={cat}
            className={`filtro-btn ${filtro === cat ? 'filtro-ativo' : ''}`}
        ...
        {eventosFiltrados.map((evento) => (
          <div className="evento-card" key={evento.id}>
            <div className="evento-card-topo">
              ...
              <span className="evento-categoria" style={{ backgroundColor: evento.categoriaColor }}>
                {evento.categoria}
              </span>
            </div>
            <div className="evento-card-corpo">
              ...
              <div className="evento-meta">
                <span className="evento-meta-item">📅 {evento.data}</span>
                <span className="evento-meta-item">📍 {evento.local}</span>
              </div>
              <p className="evento-descricao">{evento.descricao}</p>
            </div>
            <div className="evento-card-rodape">
              <a href={evento.link} target="_blank" rel="noopener noreferrer" className="btn-saiba-mais">
                Saiba mais →
              </a>
            </div>
          </div>
